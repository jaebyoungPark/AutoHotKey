...
; 시스템 API를 직접 호출하여 배율이 적용되지 않은 "진짜 물리적 주모니터 해상도" 강제 획득
global pW := DllCall("User32.dll\GetSystemMetrics", "Int", 0, "Int") ; SM_CXSCREEN
global pH := DllCall("User32.dll\GetSystemMetrics", "Int", 1, "Int") ; SM_CYSCREEN
global pX := 0
global pY := 0
...
; ==========================================================================
; [가상 잠금(isVirtualDown) ON 상태일 때의 키 매핑]
; ==========================================================================
#HotIf isVirtualDown
*q::SendInput "{Blind}5"
*w::SendInput "{Blind}6"
