...
#Include ToggleMagnifyingGlass.ahk
;Test
;#Include Test.ahk
...
HotkeyList := ["^!+o", "^!+p", "$XButton1", "$^!+p", "$^+a", "$XButton2", "^F1", "^F2", "^F3", "^F4", "^F5", "^F6", "^F7", "^F8", "$^+=", "$MButton", "!WheelUp", "!WheelDown", "!LButton", "!RButton", "$^RButton", "$RButton", "$#RButton"]
